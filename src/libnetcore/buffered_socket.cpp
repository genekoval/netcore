...
namespace netcore {
    ...
    auto buffered_socket::cancel() noexcept -> void { inner.cancel(); }
    ...
    auto buffered_socket::connected() -> bool { return !reader.done(); }
    ...
    auto buffered_socket::read(std::size_t len)
    ...
    auto buffered_socket::try_write(const void* src, std::size_t len)
        -> std::size_t {
